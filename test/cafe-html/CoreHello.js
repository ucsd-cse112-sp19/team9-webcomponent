...
class HelloWorld extends HTMLElement {
  ...
  constructor () {
    ...
    p.innerHTML += "<span id='core_hello_text'> " + hello + " " + this.innerHTML + "</span>";
    ...
    shadowRoot.querySelectorAll("button").forEach( (elem)=>{
      elem.addEventListener('click',()=>{
        ...
        p.innerHTML = "<span id='core_hello_text'>" + languages[this.lang] + " " + this.innerHTML + "</span>";
    ...
    shadowRoot.appendChild(nameInput);

    let nameButton = document.createElement("button");
    nameButton.type = "submit";
    nameButton.id = "change_name_button";
    nameButton.innerHTML = "Change Name";
    shadowRoot.appendChild(nameButton);


    //add event listener from light dom that changes name
    shadowRoot.querySelector('#change_name_button').addEventListener('click',()=>{
          // Change content of p from above with new language
          p.innerHTML = "<span id='core_hello_text'>" + languages[this.lang] + " " + nameInput.value + "</span>";
    });
